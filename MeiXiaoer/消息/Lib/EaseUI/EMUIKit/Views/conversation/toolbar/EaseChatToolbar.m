...
//    [self addSubview:_backgroundImageView];
    ...
    _toolbarView.backgroundColor = [UIColor colorWithHexString:@"#f0f0f0"];
...
//    _inputTextView.layer.cornerRadius = 6.0f;
    ...
    UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(self.horizontalPadding,_inputTextView.frame.size.height + self.verticalPadding, WIDTH - 90, 1)];
    lineView.backgroundColor = [UIColor colorWithHexString:@"#999999"];
    self.line = lineView;
    [self addSubview:lineView];
    
    //change input type 左侧语音按钮
    ...
    [styleChangeButton setImage:[UIImage imageNamed:@"图层-20"] forState:UIControlStateNormal];
    [styleChangeButton setImage:[UIImage imageNamed:@"图层-20"] forState:UIControlStateSelected];
...
//    [self.toolbarView addSubview:self.recordButton];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"图层-21"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"图层-21"] forState:UIControlStateHighlighted];
    [self.faceButton setImage:[UIImage imageNamed:@"图层-21"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"图层-13-拷贝"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"图层-13-拷贝"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"图层-13-拷贝"] forState:UIControlStateSelected];
...
- (void)textViewDidEndEditing:(UITextView *)textView
{
    ...
    lineRect.origin.y = [self _getTextViewContentH:self.inputTextView];
